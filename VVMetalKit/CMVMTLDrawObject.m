	...
	//if (self.images.count > 0)	{
		...
		//	make an argument encoder, populate it with the array of textures
			...
			for (id<VVMTLTextureImage> image in sortedImages)	{
				...
				//	an image can be missing its texture if creation failed in the pool- leave its slot null instead of crashing in useResource (skipping it entirely would shift the slots of subsequent images)
